	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	         <li class="nav-item"><a href="../YunPage" class="nav-link">首頁</a></li>
	          ...
	          <li class="nav-item"><a href="../meals2/Delicious" class="nav-link">美食佳餚</a></li>
	          <li class="nav-item"><a href="../OtherFacilities" class="nav-link">其他設施</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="../YunPage">Home</a></span> <span class="mr-2"><a href="RoomIntroduction">房型介紹</a></span> <span>豪華家庭房</span></p>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(../image/test2/DeluxeFamilyRoom/DeluxeFamilyRoom1.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(../image/test2/DeluxeFamilyRoom/DeluxeFamilyRoom2.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(../image/test2/DeluxeFamilyRoom/DeluxeFamilyRoom3.jpg);"></div>
          				</div>
          						<div class="item">
          					<div class="room-img" style="background-image: url(../image/test2/DeluxeFamilyRoom/DeluxeFamilyRoom4.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">豪華家庭房 </h2>
    						<p></p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul class="list">
	    						    <li><span>景觀:</span> 海景</li>
	    							<li><span>坪數:</span> 15坪</li>
	    						</ul>
	    						<ul class="list ml-md-5">
	    						
	    							<li><span>床:</span> 兩大床</li>
	    							<li><span>定價:</span> $NT8,800</li>
	    						</ul>
    						</div>
    						<P>客房設備:</P>
...
<!--                   <span class="icon ion-ios-search"></span> -->
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="categories">
                ...
                <li><a href="#">高級套房 <span>$NT5800</span></a></li>
                </ul>
              </div>
            </div>
</div>
