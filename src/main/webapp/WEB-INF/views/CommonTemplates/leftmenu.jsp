...
<body>
	    <div class="leftmenu">
			<ul>
				...
				<li>
					<img class="pic" src="${pageContext.request.contextPath}/image/orderlist.png">
					<a href="${pageContext.request.contextPath}/ordered/indexOrdered" class="menutxt">訂單</a>
				</li>
				<li>
					<img class="pic" src="${pageContext.request.contextPath}/image/employee.png">
					<a href="${pageContext.request.contextPath}/employee/empindex"  class="menutxt">員工</a>
				</li>
				<li>
				...
				<li>
					...
					<a href="${pageContext.request.contextPath}/room/IndexRoom" class="menutxt">房務</a>
				</li>
				<li>
					<img class="pic" src="${pageContext.request.contextPath}/image/news.png">
					<a href="${pageContext.request.contextPath}/news/newsindex" class="menutxt">消息</a>
				</li>
				<li>
					<img class="pic" src="${pageContext.request.contextPath}/image/money.png">
